...
export const openuiDefaults: Record<string, string> = {
  ...
  'openui.menu': 'Menu',
  // ── the ribbon's main menu ──────────────────────────────────────────────────
  'openui.sound': 'Sound',
  'openui.music': 'Music',
  'openui.turbo': 'Turbo',
  'openui.superTurbo': 'Super Turbo',
  'openui.history': 'History',
  'openui.info': 'Info',
  'openui.realMoney': 'Real money',
  'openui.deposit': 'Deposit',
  'openui.home': 'Home',
  'openui.baseGame': 'Base game',
  'openui.bonusGame': 'Bonus game',
  // ── the autoplay sheet ──────────────────────────────────────────────────────
  'openui.autoplay.rounds': 'Number of rounds',
  'openui.autoplay.total': 'Total: {{amount}}',
  'openui.autoplay.lossLimit': 'Loss limit',
  'openui.autoplay.winLimit': 'Single win limit',
  'openui.autoplay.stopOnFeature': 'Stop on special feature win',
  'openui.autoplay.noLimit': 'No limit',
  'openui.autoplay.custom': 'Custom',
